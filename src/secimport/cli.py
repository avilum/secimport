...
class SecImportCLI:
    ...
    def trace(
        ...
        """
        colored_print(COLORS.OKGREEN, f">>> secimport trace")
        cmd = [
    ...
    def trace_pid(
        ...
        """
        colored_print(COLORS.OKGREEN, f">>> secimport trace_pid")
    ...
    def build(trace_file: str = "trace.log") -> str:
        colored_print(COLORS.OKGREEN, f">>> secimport build")
    ...
    @staticmethod
    def run(
        sandbox_executable: str = "./traced_modules.bt",
        python_interpreter: str = sys.executable,
        entrypoint: str = None,
        pid=None,
        ...
        Args:
            sandbox_executable (str, optional): An executable sandbox file, generated by "secimport build". Defaults to "./traced_modules.bt".
        ...
        """
        colored_print(COLORS.OKGREEN, f">>> secimport run")
